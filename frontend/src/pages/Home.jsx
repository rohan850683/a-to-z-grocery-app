...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="container-app grid grid-cols-2 sm:grid-cols-4 gap-4 py-8">
        {[
          ...
          <div
            key={label}
            className="flex flex-col items-center text-center gap-2 p-4 card"
          >
            <Icon className="text-forest-500" size={28} />
